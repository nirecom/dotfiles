...
#   ~/my-private-repo → C:\git\my-private-repo (if exists)
...
# Move ~/dotfiles and ~/my-private-repo
Move-RepoIfNeeded -Source (Join-Path $HomeDir "dotfiles") -Destination $DestDir
Move-RepoIfNeeded -Source (Join-Path $HomeDir "my-private-repo") -Destination $DestDir
