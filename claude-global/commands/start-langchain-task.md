...
1. Read PJ global docs:
   - `../my-specs-repo/projects/engineering/langchain/architecture.md`
   - `../my-specs-repo/projects/engineering/langchain/progress.md`
...
5. Read `../my-specs-repo/projects/engineering/langchain/ops.md` (for incident/infrastructure tasks)
...
- my-specs-repo is PRIVATE — never reference its content in commits to public repos
