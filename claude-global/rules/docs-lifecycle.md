...
- **LangChain projects** (langchain-stack, open-webui-stack, etc.): all `.md` files under `../my-specs-repo/projects/engineering/langchain/`
- **my-specs-repo managed projects** (ai-video, nemoclaw, llama-swap): `projects/engineering/{project}/`
