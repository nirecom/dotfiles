...
| `install/linux/install-obsolete.sh` | claude-code symlink 削除コード (L41–L44) | commands → skills 一時コード削除と同時 |
| `install/win/install-obsolete.ps1` | claude-code symlink 削除コード (L26–L31) | commands → skills 一時コード削除と同時 |
