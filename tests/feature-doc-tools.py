...
"""
    ...
    def test_g4_ai_specs_path_japanese_headings(self, tmp_path):
        """G4: Path contains 'my-specs-repo' → Japanese headings."""
        # Create a subdirectory named to include my-specs-repo in its path
        ai_specs_dir = tmp_path / "my-specs-repo" / "project"
