...
- **2026-04-11** [session-sync push: retry loop for simultaneous-commit race condition](history/2026.md#session-sync-push-retry-loop-for-simultaneous-commit-race-condition) — When Windows (windows-host) and macOS (mac-host-1) push at the same time, both machines commit session data independen
...
- **2026-04-11** [git config: work email isolation via my-private-repo](history/2026.md#git-config-work-email-isolation-via-my-private-repo) — Work email and company GitLab URL need to be kept out of the public dotfiles repo.
...
- **2026-04-11** [Language policy: move rules to my-private-repo](history/2026.md#language-policy-move-rules-to-my-private-repo) — Language-related rules (code comments in English, public docs in English, private docs in Japanese) were hardcoded in th
- **2026-04-11** [Rize installer: move to my-private-repo](history/2026.md#rize-installer-move-to-my-private-repo) — Rize is a personal preference app, not a general dotfiles tool.
...
- **2026-04-11** [my-private-repo: startup fetch in .profile_common](history/2026.md#my-private-repo-startup-fetch-in-profilecommon) — my-private-repo is a sibling git repo managed alongside dotfiles, but had no automatic pull on shell startup.
...
- [Restructure /update-docs skill for my-specs-repo project coverage (uncommitted)](../history.md#restructure-update-docs-skill-for-my-specs-repo-project-coverage)
