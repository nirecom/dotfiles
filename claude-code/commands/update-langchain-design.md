...
- `architecture.md` is searched in this order:
  - Local directory `../my-specs-repo/projects/engineering/langchain/`
  - git repo `git@github.com:nirecom/my-specs-repo.git` (path: `projects/engineering/langchain/architecture.md`)
