...
dotfiles, my-private-repo, and agents are sibling repos that work together.
...
| `~/.config/git/config.local` | my-private-repo | symlink target is tracked — do not write directly |
